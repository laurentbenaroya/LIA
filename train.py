...
from dataset import Vox256, Taichi, TED, Macron
import torchvision
...
def main(rank, world_size, args):
    ...
    if args.dataset == 'ted':
        ...
        dataset = Macron(macron_rootdir, 'train', transform, False)
        dataset_test = Macron(macron_rootdir, 'val', transform)        
    else:
...
def main_single_gpu(args):
    ...
    print('==> initializing trainer')
    # Trainer
    trainer = Trainer(args, device, rank=0)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--iter", type=int, default=800000, help=' %(default)s')
    parser.add_argument("--size", type=int, default=256, help=' %(default)s')
    parser.add_argument("--batch_size", type=int, default=64, help=' %(default)s')
    parser.add_argument("--d_reg_every", type=int, default=16, help=' %(default)s')
    parser.add_argument("--g_reg_every", type=int, default=4, help=' %(default)s')
    parser.add_argument("--resume_ckpt", type=str, default=None, help=' %(default)s')
    parser.add_argument("--lr", type=float, default=0.002, help=' %(default)s')
    parser.add_argument("--channel_multiplier", type=int, default=1, help=' %(default)s')
    parser.add_argument("--start_iter", type=int, default=0, help=' %(default)s')
    parser.add_argument("--display_freq", type=int, default=5000, help=' %(default)s')
    parser.add_argument("--save_freq", type=int, default=1000, help=' %(default)s')
    ...
    parser.add_argument("--dataset", type=str, default='vox', help=' %(default)s')
    parser.add_argument("--exp_path", type=str, default='./exps/', help=' %(default)s')
    parser.add_argument("--exp_name", type=str, default='v1', help=' %(default)s')
    parser.add_argument("--addr", type=str, default='localhost', help=' %(default)s')
    parser.add_argument("--port", type=str, default='12345', help=' %(default)s')
